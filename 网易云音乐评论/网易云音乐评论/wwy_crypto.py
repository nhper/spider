...
url = 'https://music.163.com/weapi/v1/resource/comments/R_SO_4_417250909?csrf_token='
header = {
    'User-Agent': 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 '
                  '(KHTML, like Gecko) Chrome/64.0.3282.140 Safari/537.36',
    'Referer': 'http://music.163.com/song?id=417250909',
...
def get_all_comment(url):
    ...
    for i in range(page):  # 逐页抓取
        ...
        for item in json_dict['comments']:
            ...
            save_to_file(comment_info, u"music.txt")
        print("第%d页抓取完毕!" % (i + 1))
